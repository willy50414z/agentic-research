# app/freqtrade/cli.py
"""
cli.py — CLI entry point for Freqtrade subcommand dispatch.

LLM 在 implement_step 中透過 subprocess 呼叫此檔案：
    python -m app.freqtrade.cli backtest \
